...
import { System, ParadoxNotion, GameEngine, SearchPRO, UnityEditor, DG, TMPro, UnityEngine, Utils, NUnit, marijnz, RSG, Unity, MoreTags, Base, Common, Puerts, PuertsStaticWrap, SqlCipher4Unity3D, SQLiteNetExtensions, PuertsTest } from 'csharp';
...
export default function() {
   ...
   // $extension(System.Reflection.ParameterInfo, ParadoxNotion.ReflectionTools)
    $extension(UnityEngine.Animations.AnimationPlayableOutput, UnityEngine.Experimental.Animations.AnimationPlayableOutputExtensions)
    ...
    // $extension(UnityEngine.Rendering.CommandBuffer, UnityEngine.Rendering.CommandBufferExtensions)
    // $extension(UnityEngine.Rendering.CommandBuffer, UnityEngine.Rendering.PostProcessing.RuntimeUtilities)
    $extension(System.Boolean, UnityEngine.Assertions.Must.MustExtensions)
    $extension(System.Boolean, NUnit.Framework.AssertEx)
    $extension(System.Single, UnityEngine.Assertions.Must.MustExtensions)
    ...
    //$extension(UnityEditor.Profiling.Memory.Experimental.ObjectFlags, UnityEditor.Profiling.Memory.Experimental.ObjectFlagsExtensions)
    //$extension(UnityEditor.Profiling.Memory.Experimental.TypeFlags, UnityEditor.Profiling.Memory.Experimental.TypeFlagsExtensions)
    $extension(UnityEditor.EditorWindow, UnityEditor.UIElements.UIElementsEntryPoint)
    $extension(UnityEditor.EditorWindow, marijnz.EditorCoroutines.EditorCoroutineExtensions)
    ...
    $extension(UnityEditor.iOS.Xcode.PBXProject, UnityEditor.iOS.Xcode.Extensions.PBXProjectExtensions)
    ...
    $extension(UnityEngine.Rect, UnityEditor.Rendering.LookDev.RectExtension)
    ...
    $extension(UnityEditor.GenericMenu, ParadoxNotion.Design.EditorUtils)
    $extension(ParadoxNotion.Design.EditorUtils.ScriptInfo, ParadoxNotion.Design.EditorUtils)
    ...
    //$extension(UnityEditor.ShaderGraph.Internal.CoordinateSpace, UnityEditor.ShaderGraph.Internal.CoordinateSpaceExtensions)
    //$extension(UnityEditor.ShaderGraph.Internal.NeededCoordinateSpace, UnityEditor.ShaderGraph.Internal.CoordinateSpaceExtensions)
    ...
    //$extension(UnityEngine.Rendering.MaterialQuality, UnityEngine.Rendering.MaterialQualityUtilities)
    //$extension(NUnit.Framework.Constraints.ConstraintExpression, UnityEngine.TestTools.Constraints.ConstraintExtensions)
    $extension(UnityEditor.SerializedProperty, UnityEditor.Rendering.SerializedBitArrayUtilities)
    $extension(UnityEditor.SerializedProperty, DG.DemiEditor.SerializedPropertyExtensions)
    $extension(UnityEngine.Rendering.ShaderKeywordSet, UnityEditor.Rendering.Utilities.EditorMaterialQualityUtilities)
