...
public class GraphOwnerInspector : UnityEditor.Editor {
    ...
    private string graphTypeName { get { return owner.graphType.Name.SplitCamelCase(); } }

    private bool isOwnerPeristant { get { return EditorUtility.IsPersistent(owner); } }

    public bool isBoundGraphOnPrefabRoot { get { return isOwnerPeristant && owner.graphIsBound; } }
    ...
    public bool isBoundGraphPrefabOverridden { get { return boundGraphSerializationProp.prefabOverride; } }
    ...
    void DoMissingGraphControls()
    {
        ...
        if (!Application.isPlaying && GUILayout.Button("CREATE NEW #0x01")) {
            Graph newGraph = null;
            ...
            if (EditorUtility.DisplayDialog("Create Graph",
                ...
                newGraph = GraphEditor.NewAsAsset(owner);
            }
