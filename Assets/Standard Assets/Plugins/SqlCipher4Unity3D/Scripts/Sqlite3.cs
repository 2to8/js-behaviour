...
namespace SqlCipher4Unity3D
{
    ...
    public static partial class SQLite3
    {
		...
		public static extern Result Open([MarshalAs(UnmanagedType.LPStr)] string filename, out IntPtr knex_db);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_open_v2", CallingConvention = CallingConvention.Cdecl)]
		public static extern Result Open([MarshalAs(UnmanagedType.LPStr)] string filename, out IntPtr knex_db, int flags, [MarshalAs(UnmanagedType.LPStr)] string zvfs);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_open_v2", CallingConvention = CallingConvention.Cdecl)]
		public static extern Result Open(byte[] filename, out IntPtr knex_db, int flags, [MarshalAs(UnmanagedType.LPStr)] string zvfs);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_open16", CallingConvention = CallingConvention.Cdecl)]
		public static extern Result Open16([MarshalAs(UnmanagedType.LPWStr)] string filename, out IntPtr knex_db);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_enable_load_extension", CallingConvention = CallingConvention.Cdecl)]
		public static extern Result EnableLoadExtension(IntPtr knex_db, int onoff);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_close", CallingConvention = CallingConvention.Cdecl)]
		public static extern Result Close(IntPtr knex_db);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_close_v2", CallingConvention = CallingConvention.Cdecl)]
		public static extern Result Close2(IntPtr knex_db);
		...
		public static extern int Changes(IntPtr intPtr);
		...
		public static extern long LastInsertRowid(IntPtr intPtr);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_errmsg16", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr Errmsg(IntPtr intPtr);

		public static string GetErrmsg(IntPtr intPtr)
		{
			return Marshal.PtrToStringUni(Errmsg(intPtr));
		}
		...
		public static extern Result GetResult(Sqlite3DatabaseHandle knex_db);

		[DllImport(DLL_NAME, EntryPoint = "sqlite3_extended_errcode", CallingConvention = CallingConvention.Cdecl)]
		public static extern ExtendedResult ExtendedErrCode(IntPtr knex_db);
