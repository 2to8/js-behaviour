...
public class Account {
    ...
    [Ignore]
    public Company Company { get { return new Company(); } set { CompanyID = value.ID; } }
    ...
    public override int GetHashCode()
    {
        ...
        hashCode = hashCode * -1521134295
            + EqualityComparer<string>.Default.GetHashCode(this.CompanyID);
        hashCode = hashCode * -1521134295
            + EqualityComparer<Company>.Default.GetHashCode(this.Company);
...
public class IgnoreTest {
    string DbPath = $"Assets/Resources/{nameof(IgnoreTest)}.sqlite";
