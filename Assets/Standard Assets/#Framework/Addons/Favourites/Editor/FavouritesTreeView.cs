...
public class FavouritesTreeView : TreeViewWithTreeModel<FavouritesTreeElement> {
    ...
    public void LoadAndUpdate(FavouritesAsset favsAsset = null)
    {
        ...
        if (firstCat != null && TagManager.Data != null) {
            Object.FindObjectsOfType<GameObject>(true)
                .Where(go => Extensions.GetTags(go).Any() && favs.All(t => t.obj != go))
                .ForEach(go => {
    ...
    protected override DragAndDropVisualMode HandleDragAndDrop(DragAndDropArgs args)
    {
        ...
        if (args.performDrop) {
            ...
            FavouritesTreeElement draggedEle =
                DragAndDrop.GetGenericData(DragAndDropID) as FavouritesTreeElement;
            if (draggedEle != null) {
        ...
        if (Invoke_folderIconName == null) {
            ...
            if (method != null) {
                Invoke_folderIconName =
                    (System.Func<string>)System.Delegate.CreateDelegate(typeof(System.Func<string>),
                        method);
