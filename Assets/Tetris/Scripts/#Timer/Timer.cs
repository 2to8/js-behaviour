...
namespace Tetris
{
    ...
    {
        public static Timer Register(this MonoBehaviour behaviour, float duration, Action onComplete,
    ...
    public class Timer
    {
        ...
        private Timer(float duration, Action onComplete, Action onUpdate, bool dispose, bool isLooped, bool useRealTime,
            MonoBehaviour autoDestroyerOwner)
        {
